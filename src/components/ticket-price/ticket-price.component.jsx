...
export default function TicketPrice({events}) {
  ...
  return (
    <div className="bg-gray-100 background-ticket">
              ...
              <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                ...
                <div className="mt-8">
                  <div className="flex items-center">
                    <h4 className="flex-shrink-0 pr-4 bg-white text-base font-semibold text-indigo-600">
                      What's included
                    </h4>
